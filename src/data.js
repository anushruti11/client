const data = [
  {
    id: '1',
    name: 'Bihar',
    description: 'Hello This is Bihar',
    badges: [
      'Sightseeing Tours',
      'Sightseeing Tours',
      'Sightseeing Tours',
    ...
    places: [
      ...
      {
        area: 'Mahatama Gandhi Setu',
        description: 'This is Gandhi Setu',
        subImg:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Gandhi_Setu_Bridge_in_Patna%2C_India.jpg/1024px-Gandhi_Setu_Bridge_in_Patna%2C_India.jpg',
      },
      {
        area: 'Bihar Museum',
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Artistic hand carved craft',
        itemImg:
